...
#This section gives the correlations and values reported in the section 'Heterogeneity and effect sizes' in the main manuscript 

#1. Standardized mean differences----
SMDs <- tau_per_type %>% filter(effect_type == "Standardized Mean Difference") 
...
##When effect size == 0, what is average heterogeneity?
mean(SMDs$tau[SMDs$eff_size < 0.05]) #for tau = 0.016
mean(SMDs$s_I2[SMDs$eff_size < 0.05]) #I2 = 3.05
mean(SMDs$H2[SMDs$eff_size < 0.05]) #H2 = 0.88
