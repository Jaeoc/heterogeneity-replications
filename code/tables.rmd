...
het %>% knitr::kable("latex", align = "c", booktabs = TRUE,  digits = 2, col.names = c("RS", "Effect", "k", "Effect type", "Estimate", "I2(%)", "ci.lb", "ci.ub", "Zero", "Small", "Medium", "Large")) %>% 
  add_header_above(c(" " = 8, "Heterogeneity & power/type 1" = 4)) %>% 
  kable_styling("scale_down", font_size = 8) %>%
