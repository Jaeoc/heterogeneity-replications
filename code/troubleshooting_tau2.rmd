...
* First figure: replicate panel 2 but with untruncated [done]
* Hopefully the last 3 points will move up [nope :(]
* Also compare mu for truncated and untruncated versions [done]
* Maybe see if can figure out contribution of each lab to overall effect size mu [dunno]
